...
\begin{enumerate}
  ...
  \item \emph{Seed suspension}--Dissolve the contents of 5 capsules of PolySeed in 2500 mL prepared dilution water. Stir solution for 1 hour, let settle for 5-10 minutes, and decant so that visible solids are separated from solution. Gently stir remaining solution. 
