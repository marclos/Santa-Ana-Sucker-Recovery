...
Their goal was to monitor the number and behavior of many different species of fish in thermal discharge canals.  They reviewed many different tecniques for monitoring fish, and came to the conclusion that fixed underwater videography was the most effective.
