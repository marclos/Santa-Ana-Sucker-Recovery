...
As one of our first excercises, we will explore the driving question as we develop teams that might be interested to answer a subset of driving questions.
...
\subsection{Evaluating Other Public Products}

\section{Driving Question}

\section{Project Stages}

\subsection{Identifying the Public Product}

Each "issue" of the research briefs, will address a different scientific issue associated with the Santa Ana sucker--where each issues addresses a specific driving question with respect to the sucker. 
...
\section{Report Briefs}

\subsection{Identifying Characteristics of Research Briefs}

What make good brief...
