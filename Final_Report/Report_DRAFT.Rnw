...
#FORWEDNESDAYLAB PERSON: i cut out a lot of the previous stuff from this and synthesized some parts. You just need to continue the work i guess. marc said to try to cut it down to one paragraph. Good luck!

Future studies should more systematically examine the relationship between temporal variability in water temperature and algae abundance as well as provide room for more narrow sediment type categories. More than 3 reaches/sites should be used. Most importantly, \emph{Cosmopogen aeruginosus}'s co-occurrence with the federally endangered Santa Ana sucker should be examined. 
For videography, we did not formulate a standardized method with which to place our cameras in the water. For future studies, we recommend including physical place-markers in the river for the cinderblock structures as well as markers inside the structures to delineate the exact position and angle of the cameras.

The water temperature measurements seem to fluctuate but not necessarily with the air temperature measurements, averaged, from that day. Compared with the historic averages, the week of our experiment was particularly hot, but the effect on the suckers is hard to determine as the air temperature data was not collected every fifteen minutes or even hourly (as our data was), and instead we had to rely on daily highs and lows. 
...
Because there were several different groups working on projects who later shared dataw with each other, there is a possibility of unequal bias and inconsistencies in the data from group to group. Perhaps a future study could provide solutions for these inconsistencies by providing more rigid guidelines or standards across group work.
It would have also been helpful to meet with various stakeholders such as researchers, regulators, Veolia water representatives, etc. to learn more about their methods and tips for experiment design prior to conducting our own experiments.
