...
In similar studies, variations in stream temperature due to runoff were logged every 5 minutes, were found to have a negative impact on trout and the aquatic system in general \citep{jones2007effect}
