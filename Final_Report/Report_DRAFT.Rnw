...
Although we looked at few water quality parameters, we found a BOD5 differed between the upstream (22.069 mg/L) and downstream (27.3493\footnote{Do we need this many sig figures??} mg/L) location.
